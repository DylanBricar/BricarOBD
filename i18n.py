...
TRANSLATIONS = {
    ...
    "conn_step_vin_unavailable": {"fr": "   → VIN non disponible (saisie manuelle possible)", "en": "   → VIN not available (manual entry possible)"},
    "conn_vin_manual_label": {"fr": "VIN manuel :", "en": "Manual VIN:"},
    "conn_vin_apply": {"fr": "Appliquer", "en": "Apply"},
    "conn_vin_applied": {"fr": "VIN appliqué : {make} ({country})", "en": "VIN applied: {make} ({country})"},
    "conn_vin_invalid": {"fr": "VIN invalide (17 caractères requis)", "en": "Invalid VIN (17 characters required)"},
