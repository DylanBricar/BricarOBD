...
pub fn get_pid_definitions(lang: &str) -> Vec<PidDefinition> {
    vec![
        PidDefinition { pid: 0x03, name: pn(lang, "État système carburant", "Fuel System Status"), description: pn(lang, "Mode de fonctionnement du système carburant", "Fuel system operating mode"), unit: "".into(), min: 0.0, max: 255.0, bytes: 1 },
        ...
        PidDefinition { pid: 0x14, name: pn(lang, "Sonde O2 B1S1", "O2 Sensor B1S1"), description: pn(lang, "Tension sonde O2 banc 1 capteur 1", "O2 sensor bank 1 sensor 1"), unit: "V".into(), min: 0.0, max: 1.275, bytes: 1 },
        PidDefinition { pid: 0x15, name: pn(lang, "Sonde O2 B1S2", "O2 Sensor B1S2"), description: pn(lang, "Tension sonde O2 banc 1 capteur 2", "O2 sensor bank 1 sensor 2"), unit: "V".into(), min: 0.0, max: 1.275, bytes: 1 },
        PidDefinition { pid: 0x16, name: pn(lang, "Sonde O2 B1S3", "O2 Sensor B1S3"), description: pn(lang, "Tension sonde O2 banc 1 capteur 3", "O2 sensor bank 1 sensor 3"), unit: "V".into(), min: 0.0, max: 1.275, bytes: 1 },
        PidDefinition { pid: 0x17, name: pn(lang, "Sonde O2 B1S4", "O2 Sensor B1S4"), description: pn(lang, "Tension sonde O2 banc 1 capteur 4", "O2 sensor bank 1 sensor 4"), unit: "V".into(), min: 0.0, max: 1.275, bytes: 1 },
        PidDefinition { pid: 0x18, name: pn(lang, "Sonde O2 B2S1", "O2 Sensor B2S1"), description: pn(lang, "Tension sonde O2 banc 2 capteur 1", "O2 sensor bank 2 sensor 1"), unit: "V".into(), min: 0.0, max: 1.275, bytes: 1 },
        PidDefinition { pid: 0x19, name: pn(lang, "Sonde O2 B2S2", "O2 Sensor B2S2"), description: pn(lang, "Tension sonde O2 banc 2 capteur 2", "O2 sensor bank 2 sensor 2"), unit: "V".into(), min: 0.0, max: 1.275, bytes: 1 },
        PidDefinition { pid: 0x1A, name: pn(lang, "Sonde O2 B2S3", "O2 Sensor B2S3"), description: pn(lang, "Tension sonde O2 banc 2 capteur 3", "O2 sensor bank 2 sensor 3"), unit: "V".into(), min: 0.0, max: 1.275, bytes: 1 },
        PidDefinition { pid: 0x1B, name: pn(lang, "Sonde O2 B2S4", "O2 Sensor B2S4"), description: pn(lang, "Tension sonde O2 banc 2 capteur 4", "O2 sensor bank 2 sensor 4"), unit: "V".into(), min: 0.0, max: 1.275, bytes: 1 },
        ...
        PidDefinition { pid: 0x24, name: pn(lang, "Lambda sonde O2 S1", "O2 Sensor 1 Lambda"), description: pn(lang, "Rapport d'équivalence sonde O2 1", "O2 sensor 1 equivalence ratio"), unit: "ratio".into(), min: 0.0, max: 2.0, bytes: 2 },
        ...
        PidDefinition { pid: 0x34, name: pn(lang, "Courant sonde O2 S1", "O2 Sensor 1 Current"), description: pn(lang, "Courant sonde O2 1", "O2 sensor 1 current"), unit: "mA".into(), min: -128.0, max: 127.99, bytes: 4 },
