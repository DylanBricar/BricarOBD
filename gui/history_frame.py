...
class HistoryFrame(ctk.CTkFrame):
    ...
    def _setup_ui(self):
        ...
        # Help description
        ctk.CTkLabel(self, text=t("hist_help"), font=FONTS["small"], text_color=COLORS["text_muted"]).pack(anchor="w", padx=16, pady=(0, 8))
    ...
    def _on_lang_change(self, lang=None):
        ...
        self.title_label.configure(text=t("hist_title"))
        self.refresh_btn.configure(text=t("hist_refresh"))
